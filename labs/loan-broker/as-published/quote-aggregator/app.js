...
exports.handler = async (event) => {
    ...
    // REQUIRED FIX (see ../MODIFICATIONS.md): upstream declares no binding here.
    // NodejsFunction bundles with esbuild, whose output is strict-mode ESM, where an
    // undeclared assignment is a ReferenceError rather than an implicit global.
