    ...
    private _createBankFunction(config: {
        ...
        return new lambda.Function(this, config.bankName, {
            ...
            environment: {
                ...
                // FLOCI SHIM — see ../MODIFICATIONS.md. Floci does not yet apply
                // onSuccess destinations on async invoke, so when this is "1" the
                // handler puts the same event on the bus itself. Off by default.
